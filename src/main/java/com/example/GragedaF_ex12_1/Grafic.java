...
public class Grafic {
    ...
    private int cenX, cenY; //Posició del centre del gràfic
    private int amplada, altura; //Dimensions de la imatge
    private double incX, incY; //Velocitat desplaçament
    private double angle, rotacio; //Angle i velocitat de rotació
    ...
    private View view; //On dibuixarem el gràfic (utilitzat en view.invalidate)
